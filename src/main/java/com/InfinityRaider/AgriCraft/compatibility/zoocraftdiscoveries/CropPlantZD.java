...
public class CropPlantZD extends CropPlant {
    Item seed;
    ...
    public CropPlantZD(ItemStack seed, ItemStack fruit, Block plant) {
    ...
    public ArrayList<ItemStack> getFruitsOnHarvest(int gain, Random rand) {
        int minAmount = 2;
        int maxAmount = 3;
        int amount = minAmount + rand.nextInt(maxAmount - minAmount + 1);
